...
良い例:
- `dotfilesにtimes投稿のSkill作った。Webhook経由でサクッといける構成にできて気持ちいい`
- `<INTERNAL_SERVICE>のN+1クエリ潰したらレスポンス40%速くなった。こういう地味な改善が一番効くやつ`
- `Terraformのstate import 15件、地道だったけど全部通った。途中でdeprecatedな属性に引っかかってちょっと焦った`
